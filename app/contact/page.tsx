...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Spice Garden. Make a reservation, find our location, or reach out with any questions.",
}
      ...
      <section className="pt-40 pb-24 px-6 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative">
          ...
          <p className="text-foreground/60 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed opacity-0 animate-fade-in-up animation-delay-200">
            We would love to hear from you. Make a reservation, ask a question, 
            or simply say hello.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="flex gap-5 group">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@spicegarden.in" className="text-foreground/60 hover:text-primary transition-colors">
                      info@spicegarden.in
                    </a>
                  </div>
                </div>
            ...
            <div id="reserve">
              ...
              <div className="bg-card/30 rounded-3xl p-8 md:p-10 border border-border/50">
                <ReservationForm />
              </div>
            </div>
          </div>
